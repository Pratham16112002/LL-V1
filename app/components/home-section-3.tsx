    ...
    <div
      ...
      >
        ...
        >
          ...
          <p className=" md:max-w-2xl text-left text-background mx-2 md:mx-12 text-md md:text-lg leading-relaxed flex flex-1">
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit libero nulla asperiores ratione perferendis, facere voluptatem architecto itaque consequuntur et laborum est provident ab necessitatibus illo aut expedita officiis neque.
          </p>
          </div>
        </div>
      </div>
