...
const HomeSectionThree = () => {
  return (
    <div className="w-full flex justify-center py-10 bg-center ">
      <div
        className="w-[90%]  aspect-[16/9] bg-cover bg-center border border-foreground rounded-md relative"
        style={{ backgroundImage: 'url(/home/home_about_us.png)' }}
      > 
        {/* overlay */}
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-start py-10 px-6 overflow-y-scroll space-y-9 md:space-y-72  " >

          <h3 className="text-4xl md:text-6xl font-bold text-center text-foreground">
            About Us
          </h3>
          <p className="text-center text-white mx-2  md:mx-12  text-sm md:text-md leading-relaxed">
