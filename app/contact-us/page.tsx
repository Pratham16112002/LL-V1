...
export default function Contact() {
  ...
  return (
    <>
      <Navigation />
      <div className="bg-gradient-to-br from-primary/5 to-accent/5 mt-24 md:mt-32  flex flex-row h-80 md:h-120">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center flex-col justify-center">
          <h1 className="text-5xl font-bold md:text-left md:w-full text-foreground mb-6">Contact Us</h1>
          <p className="text-xl text-muted-foreground max-w-2xl text-center md:text-left md:w-full">
            Get in touch with our team to learn more about our services and how we can support you.
          </p>
        </div>
        <img src={'/contact-us/contact-us-title.png'} className="w-[60%]  hidden md:flex my-3 rounded-sm"/>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-12 bg-primary/5 p-6 ">
            ...
            <div className="bg-gradient-to-br from-primary/5 to-accent/5 p-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" className="w-full btn-primary rounded-none flex items-center justify-center gap-2">
                  <Send size={16} />
                  Send Message
                </button>
